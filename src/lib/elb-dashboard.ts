/** Options shared by all dashboard generator functions */
export interface ELBDashboardOpts {
    /** ARN or CF Ref/Att of ELB Load Balancer */
    loadbalancer?: string | object;
    /** ARN or CF Ref/Att of ECS Cluster */
    cluster?: string | object;
    /** ARN or CF Ref/Att of ECS Service */
    service?: string | object;
    /** ARN or CF Ref/Att of ELB Target Group */
    targetgroup?: string | object;
    /** Apache formatted CloudWatch log group */
 ...
 */
export default function elbDashboard(opts: ELBDashboardOpts): { widgets: object[] } {
