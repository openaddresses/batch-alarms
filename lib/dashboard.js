export default {
    widgets: [
        ...
        },
        {
            ...
            'properties': {
                title: 'Recent Errors',
                'query': "SOURCE '${Apache}' | fields @timestamp, @message | sort @timestamp desc | filter @message like /.*Error:.*/ | display @timestamp, @message, @logStream",
                'region': '${AWS::Region}',
                'stacked': false,
                'view': 'table'
            }
